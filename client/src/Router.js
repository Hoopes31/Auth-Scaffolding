    ...
    return (
      <Grid>
        ...
        <Switch>
          ...
          <Route
            path="/signup"
            component={this.loggedOutOnly(
              <SignUp checkForCredentials={this.checkForCredentials} />
            )}
          />
          <Route
            path="/login"
            component={this.loggedOutOnly(<Login login={this.login} />)}
          />
          <Route path="/profile" component={this.protect(<Profile />)} />
          <Route
            path="/admindashboard"
            component={this.adminOnly(<AdminDashboard />)}
          />
